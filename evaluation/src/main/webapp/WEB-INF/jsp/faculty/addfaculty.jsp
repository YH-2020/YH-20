                ...
                <form class="layui-form" id="form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="facultynumber" name="facultynumber" required="" lay-verify="facultynumber"
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="facultyname" name="facultyname" required="" lay-verify="facultyname"
                          autocomplete="off" class="layui-input">
                      </div>
