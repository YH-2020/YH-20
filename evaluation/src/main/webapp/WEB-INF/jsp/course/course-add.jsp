...
<div class="layui-fluid">
            <div class="layui-row">
				...
				<div class="layui-form-item">
                     ...
                     <div class="layui-input-inline">
                     <input type="text" id="coursenumber" name="coursenumber"  autocomplete="off" class="layui-input"></div>
                </div>
				<div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn" lay-filter="add" lay-submit="add">增加</button></div>
                </form>
            </div>
        </div>
</body>
