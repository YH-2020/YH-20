...
<head>
    ...
    <body>
                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_majorid" name="majorid" required="" lay-verify="majorid" value=" ${major.majorid}" autocomplete="off" class="layui-input" ></div>
        ...
        function update(){
        	var url="${pageContext.request.contextPath}/manager/updatemajor_submit";
        	var param = $(".layui-form").serialize();
